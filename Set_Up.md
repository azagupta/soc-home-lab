# SOC Home Lab: Sysmon → Wazuh → TheHive
...
Verified the VirtualBox installer hash against the official SHA256SUMS before running it.

<img width="1920" height="1080" alt="Grabbing the sysmon config file" src="https://github.com/user-attachments/assets/c9552a4e-b464-4c5e-864b-60bf3272b32f" />

Pulled Olaf Hartong's `sysmon-modular` config for MITRE-mapped logging.

<img width="1920" height="1080" alt="Installing sysmon and checking services" src="https://github.com/user-attachments/assets/5db4af13-bc9c-4556-acf1-a2004b520d61" />

Installed Sysmon with the custom config; confirmed the service is running.

<img width="1920" height="1080" alt="Sysmon event view logs" src="https://github.com/user-attachments/assets/3817571e-7bec-4b82-821a-c91526ceaa06" />

Confirmed events flowing into Windows Event Viewer.
...
Ubuntu 24.04 server provisioned on Vultr.
...
Install finished; dashboard credentials generated.
...
Confirmed the dashboard was reachable and login worked.
...
Configured the Windows agent deployment from the dashboard.
...
Agent connected and reporting as Active.
...
Alerts flowing in with automatic MITRE ATT&CK mapping.
...
Real SSH brute-force traffic captured from the public internet, not simulated.
...
Working TheHive organisation and analyst account set up.
...
Escalated a real Wazuh alert into a documented case for triage.
